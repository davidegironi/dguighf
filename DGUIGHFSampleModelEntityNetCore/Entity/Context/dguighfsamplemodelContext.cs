...
namespace DG.UIGHFSample.Model.Entity.Context
{
    public partial class dguighfsamplemodelContext : DbContext
    {
        ...
        public dguighfsamplemodelContext(DbContextOptions<dguighfsamplemodelContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) { if (optionsBuilder.IsConfigured == false) optionsBuilder.UseSqlServer(System.Configuration.ConfigurationManager.AppSettings["dguighfsamplemodelConnectionString"]); }
