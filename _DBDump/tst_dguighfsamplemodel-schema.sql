...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'tst_dguighfsamplemodel')
BEGIN
CREATE DATABASE [tst_dguighfsamplemodel]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'tst_abuighftest', FILENAME = N'/var/opt/mssql/data/tst_dguighfsamplemodel.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'tst_abuighftest_log', FILENAME = N'/var/opt/mssql/data/tst_dguighfsamplemodel_1.ldf' , SIZE = 5184KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
 COLLATE Latin1_General_CI_AS
END;
ALTER DATABASE [tst_dguighfsamplemodel] SET COMPATIBILITY_LEVEL = 100;
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [tst_dguighfsamplemodel].[dbo].[sp_fulltext_database] @action = 'enable'
end;
ALTER DATABASE [tst_dguighfsamplemodel] SET ANSI_NULL_DEFAULT OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET ANSI_NULLS OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET ANSI_PADDING OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET ANSI_WARNINGS OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET ARITHABORT OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET AUTO_CLOSE OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET AUTO_SHRINK OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET AUTO_UPDATE_STATISTICS ON;
ALTER DATABASE [tst_dguighfsamplemodel] SET CURSOR_CLOSE_ON_COMMIT OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET CURSOR_DEFAULT  GLOBAL;
ALTER DATABASE [tst_dguighfsamplemodel] SET CONCAT_NULL_YIELDS_NULL OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET NUMERIC_ROUNDABORT OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET QUOTED_IDENTIFIER OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET RECURSIVE_TRIGGERS OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET  DISABLE_BROKER;
ALTER DATABASE [tst_dguighfsamplemodel] SET AUTO_UPDATE_STATISTICS_ASYNC OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET DATE_CORRELATION_OPTIMIZATION OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET TRUSTWORTHY OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET ALLOW_SNAPSHOT_ISOLATION OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET PARAMETERIZATION SIMPLE;
ALTER DATABASE [tst_dguighfsamplemodel] SET READ_COMMITTED_SNAPSHOT OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET HONOR_BROKER_PRIORITY OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET RECOVERY FULL;
ALTER DATABASE [tst_dguighfsamplemodel] SET  MULTI_USER;
ALTER DATABASE [tst_dguighfsamplemodel] SET PAGE_VERIFY CHECKSUM;
ALTER DATABASE [tst_dguighfsamplemodel] SET DB_CHAINING OFF;
ALTER DATABASE [tst_dguighfsamplemodel] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF );
ALTER DATABASE [tst_dguighfsamplemodel] SET TARGET_RECOVERY_TIME = 0 SECONDS;
ALTER DATABASE [tst_dguighfsamplemodel] SET DELAYED_DURABILITY = DISABLED;
ALTER AUTHORIZATION ON DATABASE::[tst_dguighfsamplemodel] TO [sa];
ALTER DATABASE [tst_dguighfsamplemodel] SET  READ_WRITE;
USE tst_dguighfsamplemodel;
-- TABLES
